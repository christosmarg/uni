...
class Subject
{
	...
	public:
		...
		inline const std::string& get_code() const {return this->code;}
		inline const std::string& get_sname() const {return this->sname;}
		inline unsigned int get_subjsemester() const {return this->subjsemester;}
